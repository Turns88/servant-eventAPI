...
#endif /* VERSION_servant_eventAPI */
#ifndef MIN_VERSION_servant_eventAPI
#define MIN_VERSION_servant_eventAPI(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_servant_eventAPI */
...
#define CURRENT_PACKAGE_KEY "servant-eventAPI-0.1.0.0-EJBPrvwheK8E3WDjyrk4tC"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "servant-eventAPI-0.1.0.0-EJBPrvwheK8E3WDjyrk4tC"
